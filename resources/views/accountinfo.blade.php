    ...
    <div class="container-fluid row" style="max-height: 700px">
        <div class="col-6" style="font-size: 30px;margin-left: 10%; margin-top: 70px">
            ...
            <form method="POST" action="{{route('updateUser',['id'=>$user->id])}}">
                @csrf
                <div >
                    <img style="border: 5px soild black; margin-top:-40px;margin-bottom: 40px; border-radius: 50px 50px 50px 50px; display: inline-block" width="200px" height="200px" src="images/logo.png">
                    <label style="margin-left: 185px; margin-top:-50px;  font-size: 20px;border-radius :10px 10px 10px 10px; background-color: black;color:white; display: inline-block;  cursor: pointer; padding : 6px 7px" >
                ...
                <div> 
                    Name : 
                    <input id="name" name="name" type="text" value="{{$user->name}}" style="display: inline-block; border-radius: 5px 5px 5px 5px; float: right;margin-right: 170px" >
                </div> 
                <div style="margin-top: 20px"> 
                    Email : 
                    <input id='email' name="email" type="text" value="{{$user->email}}" style="display: inline-block; border-radius: 5px 5px 5px 5px; float: right;margin-right: 170px" >
                </div> 
                <div  style="margin-top: 20px"> 
                    Birthday : 
                    <input id="birthday" name="birthday" type="date" value="{{$user->birthday}}" style="width: 500px: inline-block; border-radius: 5px 5px 5px 5px; float: right;margin-right: 170px" >            
                </div> 
                <div  style="margin-top: 20px"> 
                    Sex :
                    <select id="sex" name="sex" value="{{$user->sex}}" style="display: inline-block; border-radius: 5px 5px 5px 5px; float: right;margin-right: 170px"  >
                ...
                <div  style="margin-top: 20px"> 
                    Phone :
                    <input id="phone" name="phone" type="number" value="{{$user->phone}}" style="display: inline-block; border-radius: 5px 5px 5px 5px; float: right;margin-right: 170px" >            
                </div>
                <div  style="margin-top: 20px">
                    Country :
                    <select id="ct" name="ct" value="{{$user->phone}}" style="display: inline-block; border-radius: 5px 5px 5px 5px; float: right;margin-right: 170px">
