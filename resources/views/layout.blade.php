...
<html lang="en">
    <head>
        ...
        <link rel = "stylesheet" type = "text/css" href = "{{asset('style/home_style.css')}}">
        <link rel = "stylesheet" type = "text/css" href = "{{asset('style/news_style.css')}}">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden sm:-my-px sm:ml-5 sm:flex">
                            ...
                            <x-jet-nav-link class="nav1" href="{{ route('tintuc') }}">
                                {{'Tin tức'}}
                            </x-jet-nav-link>
                            @if (Auth::check())
